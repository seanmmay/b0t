...
describe('mongodb module', () => {
  ...
  describe('query', () => {
    it('should execute query successfully', async () => {
      const result = await mongodb.query('SELECT * FROM test');
      expect(result).toBeDefined();
    });

    it('should handle connection errors', async () => {
      // Mock connection error
      await expect(mongodb.query('INVALID SQL'))
        .rejects.toThrow();
    });
  });
  ...
  describe('insert', () => {
    it('should insert data successfully', async () => {
      ...
      const result = await mongodb.insert('test_table', data);
      expect(result.insertedId).toBeDefined();
    });

    it('should validate required fields', async () => {
      await expect(mongodb.insert('test_table', {}))
  ...
  describe('delete', () => {
    it('should delete data successfully', async () => {
      const result = await mongodb.remove('test_table', { id: '123' });
