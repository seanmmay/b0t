...
describe('mysql module', () => {
  ...
  describe('query', () => {
    ...
    it('should handle connection errors', async () => {
      ...
      await expect(mysql.query('INVALID SQL'))
        .rejects.toThrow();
    });
  });
  ...
  describe('insert', () => {
    it('should insert data successfully', async () => {
      ...
      const result = await mysql.insert('test_table', data);
      expect(result.insertedId).toBeDefined();
    });

    it('should validate required fields', async () => {
      await expect(mysql.insert('test_table', {}))
  ...
  describe('delete', () => {
    it('should delete data successfully', async () => {
      const result = await mysql.remove('test_table', { id: '123' });
